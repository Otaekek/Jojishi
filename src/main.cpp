...
int main()
{
	...
	runtimeLibrary::create_lib("assets/levelBuilder/level01.cpp");
	...
	500, 550, texture_builtin::create_instance(fileLoader::load_fs_asset_sync("assets/graphic/texture/grass.jpg", 1)), 40,
